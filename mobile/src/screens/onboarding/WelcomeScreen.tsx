...
const styles = StyleSheet.create({
  ...
  tagline: { fontSize: 16, color: '#B8E6D1', marginTop: 8 },
  features: { gap: 16 },
  featureRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  featureCheck: { fontSize: 18, color: 'rgba(255,255,255,0.72)' },
  ...
  disclaimer: { fontSize: 11, color: 'rgba(255,255,255,0.72)', textAlign: 'center', lineHeight: 16 },
});
