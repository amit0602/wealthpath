...
const styles = StyleSheet.create({
  ...
  featureCheck: { fontSize: 18, color: '#B8E6D1' },
  featureText: { fontSize: 16, color: 'rgba(255,255,255,0.90)', flex: 1 },
  actions: { gap: 16 },
  ...
  disclaimer: { fontSize: 11, color: 'rgba(255,255,255,0.50)', textAlign: 'center', lineHeight: 16 },
});
